...
@section('page-content')
    <div class="container-fluid mt-3" style="height: 100vh">
        ...
        <div class="row mt-4  mb-2 py-1 ">
            <div class="col-md-6  "   >
                <h4 >Liste des dix derniers incidents </h4>
                <hr>
            </div>
            <div class="col-md-2 "></div>
            <div class="col-md-4 d-flex justify-content-end " >

                <button type="button" class="btn " style="background: #fba407; color:#fff ; font-size:16px " data-bs-toggle="modal" data-bs-target="#exampleModal">Declarer un incident</button>
                                    ...
                                    <td>
                                       <div class="userDatatable-content">
                                            ...
                                            @if($incident->heureRetourNormal == '')
                                                <a class="btn " href="{{ url('incidents/'. $incident->id .'/updateTime') }}" style="background-color: #ff8333; color:#fff">Retour au normal</a>
                                            @else

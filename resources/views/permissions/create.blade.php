...
@section('page-content')
    <div class="container-fluid mt-3" style="height:100vh;">
        ...
        <div class="row mt-3">
            <div class="col-md-6 offset-md-3 text-center py-2 mb-4" style="background-color: #fba407; border-radius:5px; color:white; font-size:16px; font-weight:bold">Fiche de demande de permission</div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card py-10" style="border: white solid 1px; ">
                    <p style="margin-left: 13px"><span>1-</span> Bienvenue sur le formulaire de demande de permission,veuillez remplir tous les champs ci-possible !!! </p>
                ...
                <div class="col-lg-12">
                    <div class="card card-default card-md mb-4">
                        <div class="card-header" style="background-color: white">
                            <h6 style="color: #fba407">Formulaire de demande de permission</h6>
                        </div>
                            ...
                            <form action="{{ route('permissions.store') }}" method="POST" id="myForm">
                                ...
                                <div class="form-row mx-n15">
                                    ...
                                    <div class="col-md-6 mb-20 px-15">
                                        <p class="mb-6 mt-4">Debut de la permission</p>
                                        <label for="dateDepart" class="il-gray fs-14 fw-500 align-center">Date de debut *</label>
                                        <input type="date" class="form-control  ih-medium ip-light radius-xs b-light" id="dateDepart" name="dateDepart" placeholder="" required>
                                        <label for="heureDepart" class="il-gray fs-14 fw-500 align-center mt-3">Heure de debut *</label>
                                        <input type="time" class="form-control  ih-medium ip-light radius-xs b-light" id="heureDepart" name="heureDepart" placeholder="00:00 " required>

                                    </div>
                                    <div class="col-md-6 mb-20 px-15" >
                                        <p class="mb-6 mt-4">Fin de la permission</p>
                                        <label for="dateFin" class="il-gray fs-14 fw-500 align-center">Date de reprise *</label>
                                        <input type="date" class="form-control  ih-medium ip-light radius-xs b-light" id="dateFin" name="dateFin" placeholder="" required>
                                        <label for="heureFin" class="il-gray fs-14 fw-500 align-center mt-3">Heure de reprise *</label>
